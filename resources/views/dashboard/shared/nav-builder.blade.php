...
<ul class="c-sidebar-nav">
    ...
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('kategori') }}">
            <i class="c-sidebar-nav-icon"></i>
            Kategori
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('tempo') }}">
            <i class="c-sidebar-nav-icon"></i>
            Tempo
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('denda') }}">
            <i class="c-sidebar-nav-icon"></i>
            Denda
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('bunga') }}">
            <i class="c-sidebar-nav-icon"></i>
            Bunga
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('biayaAdministrasi') }}">
            <i class="c-sidebar-nav-icon"></i>
            Biaya Administrasi
        </a>
    </li>
    ...
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('pinjaman') }}">
            <i class="c-sidebar-nav-icon"></i>
            Pinjaman
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="{{ url('angsuran') }}">
            <i class="c-sidebar-nav-icon"></i>
            Angsuran
        </a>
    </li>
